...
\includepdf[pages=1,fitpaper=false,width=\paperwidth,height=\paperheight,pagecommand={\thispagestyle{empty}}]{kapak.pdf}
\setcounter{page}{1}   % sayfa numarasını kapak sonrası sıfırla
...
%%Here is some text with a \pdftooltip{hover over me}{This is the original text hidden underneath}.
