...
Çok küçüklerin dünyasında (mikroskopik seviyede) dalga davranışını gözlemek mümkünken, büyüklerin dünyasında (makroskopik seviyede) dalga davranışını gözlemek mümkün değildir. Örneğin, 0.1 mm büyüklüğünde ve 10 cm/s ile ilerleyen bir su damlası için De Broglie dalga boyu,
%%
\begin{equation*}
\lambda = h/p = 6.6\times 10^{-27}/(4\times 10^{-5}\eqsim 1.6\times 10^{-22} \text{cm})
\end{equation*}
%%
...
\item Bu durağan seviyeler Rutherford atom modelindeki izinli yörüngelere (orbitlere) karşılık gelirler. Bu yörüngelerde elektronlar klasik fizikteki gibi herhangi bir açısal momentum değerini alamazlar. Bunun yerine açısal momentumu,
\begin{equation}
