...
\end{equation} 
%%
olarak tanımlanır. Planck $E$'nin sürekli bir değişken değilde izinli ve kesikli değerlere sahip olması gerektiğini düşündüğünden, $n = 0, 1, 2, \dots$  olmak üzere, Denk. \ref{eq:AvE_Boltzmann},
%%
\begin{equation}
