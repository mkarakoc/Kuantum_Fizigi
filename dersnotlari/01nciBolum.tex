...
\item {\bf Eğer ışığın frekansı belirli bir değerin altındaysa fotoelektrik etki gerçekleşmez:} Deney düzeneğindeki metal plakanın cinsine bağlı olarak ışığın frekansı yetersizse, şiddeti ne olursa olsun ışık elektron yayınlanmasını sağlayamaz.
