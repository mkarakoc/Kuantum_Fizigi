...
Kovuğun içindeki enerji yoğunluğunun ($w(\lambda,T)$) yayınlama gücü $E(\lambda,T)$ ile olan ilişkisi aşağıdaki gibidir,
...
\end{equation}
%%
burada $c$ ışığın boşluktaki hızıdır ve $w$'nin birimi $J/m^3$'tür. Wilhelm Wien 1894 yılında enerji yoğunluğunun (deneysel verilerin bir sonucu olarak), 
%%
\begin{equation}
\label{eq:f_lambdaT}
...
Tanımlanan yeni ifade ile önceki ifade arasında,
